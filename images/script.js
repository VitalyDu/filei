...
stpbl1.onmouseover = function(){
    stpbrdr1.style.borderBottom = "3px solid yellow";
}
...
stpbl2.onmouseover = function(){
    stpbrdr2.style.borderBottom = "3px solid red";
}
stpbl2.onmouseout = function(){
    stpbrdr2.style.borderBottom = "3px solid brown";
}

stpbl3.onmouseover = function(){
    stpbrdr3.style.borderBottom = "3px solid aqua";
}
stpbl3.onmouseout = function(){
    stpbrdr3.style.borderBottom = "3px solid gray";
}